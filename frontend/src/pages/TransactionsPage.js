      ...
      return (
        <div className="flex items-center gap-2 mt-2">
          ...
          <select
            ...
            className="bg-zinc-900 border border-zinc-700 rounded-md px-2 py-1 text-white text-sm focus:ring-2 focus:ring-cyan-400 outline-none"
          >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
            <select
              ...
              className="bg-zinc-900 border border-zinc-700 rounded-md p-3 text-white cursor-pointer focus:ring-2 focus:ring-cyan-400 outline-none transition"
            >
            ...
            <input
              ...
              placeholder="Amount"
              className="bg-zinc-900 border border-zinc-700 rounded-md p-3 text-white placeholder-gray-500 text-right focus:ring-2 focus:ring-cyan-400 outline-none transition"
          ...
          <div className="flex justify-between mt-5">
            <button
              type="submit"
              className="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 rounded-md font-medium transition"
            >
              Add Transaction
            </button>
            ...
            <button
              ...
              className="px-6 py-2 bg-red-600 hover:bg-red-700 rounded-md font-medium transition"
            >
              Remove Latest
            </button>
          </div>
